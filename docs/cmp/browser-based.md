...
```http
GET https://einwilligungsspeicher.netid.de/netid-permissions?q.tapp_id.eq=<TAPP_ID> HTTP/1.1
...
Accept: application/vnd.netid.permission-center.netid-permissions-v1+json
Cookie: tpid_sec=<JWT_TOKEN>
Origin: <ORIGIN>
